...
if(isset($_POST["continue"])) {
	...
	if($validate->check_password($password, $error_passwd)) {
		...
		if(!isset($existuser)) {
			...
			echo "<meta http-equiv='Refresh' content='1; url=./registration_confirmation_email.php'>";
		} else {
			$formerror="User already exists in the system";
		}
	}		
}		
?>
	...
	<div class="container">
		...
		<h3 class="text-center" style="color:#35AA84;"><strong>Create your ABC Jobs account</strong></h3>
			...
			<form class="form-horizontal" id="registration_form" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post" onsubmit="form_validation();"><br/>
				...
				<div class="form-group"> 
					<div class="col-md-offset-9 col-md-3 text-right">
						<input type="submit" name="continue" id="continue" value="Continue" class="btn btn-success" style="background-color:#35AA84;padding:0.375em 1.375em;">
					</div>
				</div>
