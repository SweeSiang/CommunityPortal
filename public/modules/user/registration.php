...
if(isset($_POST["register"])) {
	...
	if($validate->check_password($password, $error_passwd)) {
		...
		if(!isset($existuser)) {
			...
			echo "<meta http-equiv='Refresh' content='1; url=./registration_confirmation.php'>";
		} else {
			...
			<form class="form-horizontal" id="registration_form" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post" onsubmit="form_validation();"><br/>
				...
				<div class="form-group"> 
					<div class="col-md-offset-9 col-md-3 text-right">
						<input type="submit" name="register" id="register" value="Sign Up" class="btn btn-success" style="background-color:#35AA84;padding:0.375em 1.375em;">
					</div>
				</div>
