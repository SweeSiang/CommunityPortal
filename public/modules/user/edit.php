...
if(isset($_POST["edit"])) {	
	...
	if($update) {
		echo "HI";
		$existuser=$UM->getUserById($_SESSION["userid"]);
		$existuser->id=$_SESSION["userid"];
...
?>
	...
	<div class="container">
		...
		<h3 class="text-center" style="color:#35AA84;"><strong>Edit ABC Jobs account</strong></h3>
			...
			<form class="form-horizontal" id="registration_form" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post" onsubmit="form_validation();"><br/>
				...
				<div class="form-group"> 
					<div class="col-md-offset-9 col-md-3 text-right">
						<input type="submit" name="edit" id="edit" value="Edit" class="btn btn-success" style="background-color:#35AA84;padding:0.375em 1.375em;">
					</div>
				</div>
